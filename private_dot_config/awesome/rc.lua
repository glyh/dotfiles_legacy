...
function alter_sound(delta, limited)
   arg = ""
   if limited then
   ...
   awful.spawn.with_shell("bash -c 'mpg123 -f 5000 ~/.config/awesome/sounds/toggle-speaker.mp3'")
end
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "j",
        ...
        {description = "focus the client beneath", group = "client"}
    ),
    awful.key({ modkey,           }, "k",
        function ()
    ...
    awful.key({ modkey, "Shift"   }, "j", function () awful.client.swap.bydirection("down")    end,
              {description = "swap with the client beneath", group = "client"}),
    ...
    awful.key({ modkey, "Shift"   }, "l",      function () awful.client.swap.bydirection("right")    end,
              {description = "swap with the clien on the right", group = "client"}),
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.spawn.with_shell("rofi -no-lazy-grab -show drun -modi drun") end,
    ...
    awful.key({         "Shift"   }, "XF86AudioRaiseVolume", function() alter_sound(10, false) end,
              {description = "VOLUME UP", group = "System"}),
    awful.key({         "Shift"   }, "XF86AudioLowerVolume", function() alter_sound(-10, false) end,
              {description = "VOLUME DOWN", group = "System"}),
    awful.key({                   }, "XF86AudioMute", function() alter_sound(0, false) end,
...
function spawn_once(command)
  awful.util.spawn_with_shell("~/.config/awesome/run_once.sh " .. command)
end

spawn_once("picom -b") -- some cool effects
spawn_once("fcitx &") -- Install IME
